...
from config.config import device_data  # Importing device_data from config.config module
from execution.login import JSONResponse  # Importing JSONResponse from execution.login module
